...
public class MainActivity extends FragmentActivity implements View.OnClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback, TextureView.SurfaceTextureListener {
    ...
    private void initFlightController() {
        ...
        mFlightController.setGoHomeHeightInMeters(20f, new CommonCallbacks.CompletionCallback() {
            @Override
    ...
    public void downloadPhoto(MediaFile photoFile)
    {
        ...
        mMediaManager.fetchMediaData(photoFile, getApplicationContext().getFilesDir(), null,
                new MediaManager.DownloadListener<String>() {
                    @Override
                    public void onStart() {
